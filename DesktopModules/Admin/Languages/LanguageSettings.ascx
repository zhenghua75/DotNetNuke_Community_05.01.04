...
<table cellspacing="1" cellpadding="1" border="0">
    ...
    <tr>
        ...
        <td width="350">
            ...
            <asp:RangeValidator ID="valPageSize" runat="server" ControlToValidate="txtPageSize" resourcekey="PageSize.Error" Type="Integer" Display="Dynamic" CssClass="NormalRed" />
        </td>
    </tr>
</table>
<p align="center">
