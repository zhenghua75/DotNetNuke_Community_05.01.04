...
<asp:Panel ID="pnlScheduleItem" runat="server">
    <table cellspacing="0" cellpadding="3" width="750" summary="Edit Schedule" border="0">
        <tr valign="top">
            <td class="SubHead" width="150"><dnn:Label ID="plType" runat="server" ControlName="txtType" Text="Full Class Name and Assembly:"/></td>
            <td class="Normal"><asp:TextBox ID="txtType" Width="450" runat="server" CssClass="NormalTextBox" /></td>
        </tr>
        <tr valign="top">
            <td class="SubHead" width="150"><dnn:Label ID="plEnabled" runat="server" ControlName="chkEnabled" Text="Schedule Enabled:" /></td>
            <td class="Normal"><asp:CheckBox ID="chkEnabled" runat="server" Text="Yes" resourcekey="Yes" CssClass="NormalTextBox" /></td>
        </tr>
        <tr valign="top">
            <td class="SubHead" width="150"><dnn:Label ID="plTimeLapse" runat="server" ControlName="txtTimeLapse" Text="Time Lapse:"/></td>
            <td class="Normal">
        ...
        <tr valign="top">
            <td class="SubHead" width="150"><dnn:Label ID="plRetryTimeLapse" runat="server" ControlName="txtRetryTimeLapse" Text="Retry Frequency:"/></td>
            <td class="Normal">
        ...
        <tr valign="top">
            <td class="SubHead" width="150"><dnn:Label ID="plRetainHistoryNum" runat="server" ControlName="ddlRetainHistoryNum" Text="Retain Schedule History:"/></td>
            <td class="Normal">
        ...
        <tr valign="top">
            <td class="SubHead" width="150"><dnn:Label ID="plAttachToEvent" runat="server" ControlName="ddlAttachToEvent" Text="Run on Event:"/></td>
            <td class="Normal">
        ...
        <tr valign="top">
            <td class="SubHead" width="150"><dnn:Label ID="plCatchUpEnabled" runat="server" ControlName="chkCatchUpEnabled" Text="Catch Up Enabled:"/></td>
            <td class="Normal"><asp:CheckBox ID="chkCatchUpEnabled" runat="server" Text="Yes" resourcekey="Yes" CssClass="NormalTextBox"/></td>
        </tr>
        <tr valign="top">
            <td class="SubHead" width="150"><dnn:Label ID="plObjectDependencies" runat="server" ControlName="txtObjectDependencies" Text="Object Dependencies:"/></td>
            <td class="Normal"><asp:TextBox ID="txtObjectDependencies" runat="server" MaxLength="150" Width="390" CssClass="NormalTextBox"/></td>
        </tr>
        <tr valign="top">
            <td class="SubHead" width="150"><dnn:Label ID="plServers" runat="server" ControlName="txtServers" Text="Run on Servers:"/></td>
            <td class="Normal">
